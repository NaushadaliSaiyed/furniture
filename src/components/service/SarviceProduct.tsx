        ...
        <div className='bg-neutral-100 '>
            ...
            {/* <div className='w-3/4 flex items-center flex-col' > */}
              <div className='flex  justify-center  gap-[149px] items-center '>
                <div className='bg-white h-[416px] w-[336px] flex flex-col items-center gap-5 p-4'>
                ...
                <div className='bg-white h-[416px] w-[336px] flex flex-col items-center gap-5 p-6'>
