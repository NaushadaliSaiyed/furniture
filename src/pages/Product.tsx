    ...
    <div className='h-screen w-full'>
      ...
      <div className='flex gap-24'>
        <div className='mt-20 ml-28  '>
          <img src="../src/assets/symbioosa-lighting-llev.jpg" alt="" className='w-[530px] h-[480px] hover:animate-pulse ' />
        ...
        <div className='mt-56 mr-28'>
          <img src="../src/assets/bob-corner-sofa-module.jpg" alt="" className='w-[570px] h-[450px] hover:animate-pulse' />
      ...
      <div className='flex gap-24'>
        <div className='mt-20 ml-28  '>
          <img src="../src/assets/istockphoto2.jpg" alt="" className='w-[530px] h-[520px] hover:animate-pulse' />
          <p className='font-semibold mt-7'>UX/UI Design Research</p>
        ...
        <div className='mt-56 mr-28'>
          <img src="../src/assets/istockphoto3.jpg" alt="" className='w-[570px] h-[450px] hover:animate-pulse' />
          <p className='font-semibold mt-7'>Product Design</p>
      ...
      <div className='flex gap-24'>
        <div className='mt-20 ml-28  '>
          <img src="../src/assets/istockphoto.jpg" alt="" className='w-[530px] h-[520px] hover:animate-pulse' />
          <p className='font-semibold mt-7'>Product Design</p>
        ...
        <div className='mt-56  mr-28'>
          <img src="../src/assets/istockphoto1.jpg" alt="" className='w-[570px] h-[450px] hover:animate-pulse' />
      ...
      <div className='flex gap-24'>
        <div className='mt-20 ml-28  '>
          <img src="../src/assets/istockphoto4.jpg" alt="" className='w-[530px] h-[520px] hover:animate-pulse' />
          <p className='font-semibold mt-7'>Product Design</p>
        ...
        <div className='mt-56  mr-28'>
          <img src="../src/assets/bob-corner-sofa-module5.jpg" alt="" className='w-[570px] h-[450px] hover:animate-pulse' />
          <p className='font-semibold mt-7'>Product Design</p>
      ...
      <div className='flex gap-24'>
        <div className='mt-20 ml-28  '>
          <img src="../src/assets/istockphoto6.jpg" alt="" className='w-[530px] h-[520px] hover:animate-pulse' />
          <p className='font-semibold mt-7'>Product Design</p>
        ...
        <div className='mt-56  mr-28'>
          <img src="../src/assets/istockphoto7.jpg" alt="" className='w-[570px] h-[450px] hover:animate-pulse' />
          <p className='font-semibold mt-7'>Product Design</p>
      ...
      <div className='flex gap-24'>
        <div className='mt-20 ml-28  '>
          <img src="../src/assets/istockphoto8.jpg" alt="" className='w-[530px] h-[520px] hover:animate-pulse'/>
          <p className='font-semibold mt-7'>Product Design</p>
        ...
        <div className='mt-56  mr-28 mb-20'>
          <img src="../src/assets/istockphoto10.jpg" alt="" className='w-[570px] h-[450px] hover:animate-pulse ' />
          <p className='font-semibold mt-7'>UX/UI Design Research</p>
