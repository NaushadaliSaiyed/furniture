  ...
  return (
    ...
    <div className='h-screen w-full'>
      ...
      <div className='flex gap-24'>
        ...
        <div className='mt-52 mr-28'>
           <img src="../src/assets/istockphoto3.jpg" alt="" className='w-[570px] h-[450px]' />
           <p className='font-semibold mt-7'>Product Design</p>
      ...
      <div className='flex gap-24'>
        <div className='mt-36 ml-28  '>
          <img src="../src/assets/istockphoto.jpg" alt="" className='w-[530px] h-[520px]' />
          <p className='font-semibold mt-7'>Product Design</p>
          <p className='font-semibold text-4xl mt-5 hover:text-orange-600'>Issue tracking app</p>
          <p className='font-semibold mt-7 ' >Make your work routine simple and convenient, <br /> say goodbye to the stress and chaos of managing multiple <br /> tasks and hello to a more productive workday</p>
        </div>
        <div className='mt-52 mr-28'>
           <img src="../src/assets/istockphoto1.jpg" alt="" className='w-[570px] h-[450px]' />
           <p className='font-semibold mt-7'>UX/UI Design Research</p>
          <p className='font-semibold text-4xl mt-5 hover:text-orange-600'>Homely app</p>
          <p className='font-semibold mt-7 ' >The main goal of the platform is to offer high-level,<br /> elegant, and modern properties across Europe and South America.</p>
        </div>
      ...
      <div className='flex gap-24'>
        <div className='mt-36 ml-28  '>
          <img src="../src/assets/istockphoto4.jpg" alt="" className='w-[530px] h-[520px]' />
          <p className='font-semibold mt-7'>Product Design</p>
          <p className='font-semibold text-4xl mt-5 hover:text-orange-600'>Issue tracking app</p>
          <p className='font-semibold mt-7 ' >Make your work routine simple and convenient, <br /> say goodbye to the stress and chaos of managing multiple <br /> tasks and hello to a more productive workday</p>
        </div>
        <div className='mt-52 mr-28'>
           <img src="../src/assets/bob-corner-sofa-module5.jpg" alt="" className='w-[570px] h-[450px]' />
           <p className='font-semibold mt-7'>UX/UI Design Research</p>
          <p className='font-semibold text-4xl mt-5 hover:text-orange-600'>Homely app</p>
          <p className='font-semibold mt-7 ' >The main goal of the platform is to offer high-level,<br /> elegant, and modern properties across Europe and South America.</p>
        </div>
      ...
      <div className='flex gap-24'>
        <div className='mt-36 ml-28  '>
          <img src="../src/assets/istockphoto6.jpg" alt="" className='w-[530px] h-[520px]' />
          <p className='font-semibold mt-7'>Product Design</p>
          <p className='font-semibold text-4xl mt-5 hover:text-orange-600'>Issue tracking app</p>
          <p className='font-semibold mt-7 ' >Make your work routine simple and convenient, <br /> say goodbye to the stress and chaos of managing multiple <br /> tasks and hello to a more productive workday</p>
        </div>
        <div className='mt-52 mr-28'>
           <img src="../src/assets/istockphoto7.jpg" alt="" className='w-[570px] h-[450px]' />
           <p className='font-semibold mt-7'>UX/UI Design Research</p>
          <p className='font-semibold text-4xl mt-5 hover:text-orange-600'>Homely app</p>
          <p className='font-semibold mt-7 ' >The main goal of the platform is to offer high-level,<br /> elegant, and modern properties across Europe and South America.</p>
        </div>
      ...
      <div className='flex gap-24'>
        <div className='mt-36 ml-28  '>
          <img src="../src/assets/istockphoto8.jpg" alt="" className='w-[530px] h-[520px]' />
          <p className='font-semibold mt-7'>Product Design</p>
          <p className='font-semibold text-4xl mt-5 hover:text-orange-600'>Issue tracking app</p>
          <p className='font-semibold mt-7 ' >Make your work routine simple and convenient, <br /> say goodbye to the stress and chaos of managing multiple <br /> tasks and hello to a more productive workday</p>
        </div>
        <div className='mt-52 mr-28'>
           <img src="../src/assets/istockphoto9.jpg" alt="" className='w-[570px] h-[450px]' />
           <p className='font-semibold mt-7'>UX/UI Design Research</p>
          <p className='font-semibold text-4xl mt-5 hover:text-orange-600'>Homely app</p>
          <p className='font-semibold mt-7 ' >The main goal of the platform is to offer high-level,<br /> elegant, and modern properties across Europe and South America.</p>
        </div>
